...
KC_ASDF_NAME="asdf-bun"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-bun"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="bun"
KC_ASDF_APP_WEBS="https://bun.sh/"
KC_ASDF_APP_DESC="Bun is a fast JavaScript runtime/package manager/bundler"
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/oven-sh/bun"
